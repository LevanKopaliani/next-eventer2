  ...
  return (
    ...
    >
      <ul>
        ...
        <li className={styles.list_item} onClick={() => setPath("/#music")}>
          <Link
            href={"/#music"}
        ...
        <li className={styles.list_item} onClick={() => setPath("/#business")}>
          <Link
            href={"/#business"}
        ...
        <li className={styles.list_item} onClick={() => setPath("/#theatre")}>
          <Link
            href={"/#theatre"}
        ...
        <li className={styles.list_item} onClick={() => setPath("/#sport")}>
          <Link
            href={"/#sport"}
